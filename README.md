...
- **Reviewer** (독립 subagent) + **PM(Leader)** — 독립 검증
...
│                                                           │
│  🌟 TEAM ────────────────────────────────────────        │
│  Research: Agent Teams (3명 병렬) → Reviewer → PM        │
│  Plan:     Subagent → Reviewer → PM                      │
│  Execute:  Subagent/Teams → Reviewer → PM                │
│                                                           │
│  ✦ ARCHITECTURE ─────────────────────────────────        │
...
| Research 방식 | Solo / Subagent / Agent Teams |
...
| **Cancel** | 취소 진행 / 계속 |
| **Leader 거부 시** | 자동 수정 / 직접 가이드 / 무시 승인 / 취소 |
