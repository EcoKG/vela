...
│                                                             │
│   ⛵ Vela Gate                                🔭 Tracker     │
│   R/W mode + pipeline ordering enforcement   trace.jsonl    │
│                                                             │
│   ┌─────────────────────────────────────────────────────┐   │
│   │  P I P E L I N E                                    │   │
│   │                                                     │   │
...
│   Real-time pipeline      6 roles × 25 prompts             │
...
| 🔒 [Hooks & Enforcement](docs/hooks.md) | Vela Gate/Tracker 상세, 15가지 시크릿 패턴, 차단 메커니즘 |
